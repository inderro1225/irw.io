...
<!----form starts--->
<center><h1> <b>ADD NEW RECORD</b></h1>
...
$q="insert into customer(id,name,date,cin,cout,cleft,bin,bout,bleft,cgiven,cashleft,ename)
values($id,'$name','$date1',$cin,$cout,$cleft,$bin,$bout,$bleft,$cgiven,$cashleft,'$ename')";
