...
<center><h1> <b>VIEW ALL DETAILS BY ID</b></h1>
...
$result = mysqli_query($dbc,"SELECT * FROM customer WHERE date>='$fd' and date<='$td' having id=$id");
...
$q1="SELECT id, name, sum(cin) ,sum(cout),sum(bin),sum(bout),sum(cgiven),sum(cashleft),ename from customer where id=$id and date between
'$fd' and'$td'";
